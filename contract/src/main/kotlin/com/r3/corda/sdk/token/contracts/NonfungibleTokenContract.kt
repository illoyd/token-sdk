...
class NonfungibleTokenContract : AbstractOwnedTokenContract<NonfungibleTokenState<EmbeddableToken>>() {
    ...
    override fun groupStates(tx: LedgerTransaction): List<LedgerTransaction.InOutGroup<NonfungibleTokenState<EmbeddableToken>, IssuedToken<EmbeddableToken>>> {
        return tx.groupStates { state -> state.token }
    }

    override fun handleIssue(
            group: LedgerTransaction.InOutGroup<NonfungibleTokenState<EmbeddableToken>, IssuedToken<EmbeddableToken>>,
