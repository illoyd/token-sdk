...
class Examples : LedgerTestWithPersistence() {
    ...
    fun `creating inlined token definition`() {
        ...
        val tenPoundsIssuedByIssuerOwnedByAlice: FungibleTokenState<FiatCurrency> = 10.GBP issuedBy ISSUER.party ownedBy ALICE.party
    ...
    fun `evolvable token definition`() {
        ...
        // Redeem the NonfungibleTokenState and reissue it as an FungibleTokenState
        val oneHundredUnitsOfHouse: FungibleTokenState<TokenPointer<House>> = 100 of housePointer issuedBy BOB.party ownedBy ALICE.party
    }
